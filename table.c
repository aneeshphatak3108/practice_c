...
int find_strength(student students[], int count, char subject[], int grade) {
	int number = 0;
	if (strcmp(students[1].subject1.subject_name, subject) == 0) {
		for(int i = 0; i < count; i++) {
			if (students[i].subject1.grade == grade)
				number++;
		}
	}
	
	if (strcmp(students[2].subject2.subject_name, subject) == 0) {
		for(int i = 0; i < count; i++) {
			if (students[i].subject2.grade == grade)
				number++;
		}
	}

	if (strcmp(students[3].subject3.subject_name, subject) == 0) {
		for(int i = 0; i < count; i++) {
			if (students[i].subject3.grade == grade)
				number++;
		}
	}
	...
	if (strcmp(students[1].subject4.subject_name, subject) == 0) {
		for(int i = 0; i < count; i++) {
			if (students[i].subject4.grade == grade)
				number++;
		}
	}
	...
	if (strcmp(students[1].subject5.subject_name, subject) == 0) {
		for(int i = 0; i < count; i++) {
			if (students[i].subject5.grade == grade)
				number++;
		}
	}
	...
	if (strcmp(students[1].subject6.subject_name, subject) == 0) {
		for(int i = 0; i < count; i++) {
			if (students[i].subject6.grade == grade)
				number++;
		}
	}
	...
	if (strcmp(students[1].subject7.subject_name, subject) == 0) {
		for(int i = 0; i < count; i++) {
			if (students[i].subject7.grade == grade)
				number++;
		}
	}
	...
	if (strcmp(students[1].subject8.subject_name, subject) == 0) {
		for(int i = 0; i < count; i++) {
			if (students[i].subject8.grade == grade)
				number++;
		}
	}
	...
	if (strcmp(students[1].subject9.subject_name, subject) == 0) {
		for(int i = 0; i < count; i++) {
			if (students[i].subject9.grade == grade)
				number++;
		}
	}
	...
	if (strcmp(students[1].subject10.subject_name, subject) == 0) {
		for(int i = 0; i < count; i++) {
			if (students[i].subject10.grade == grade)
				number++;
		}
	}
	return number;
...
//	scanf("%d", &choice);
	...
	if (strcmp(option, "marks") == 0) {
		scanf("%s", surname);
		scanf("%s", name);
		scanf("%s", middlename);
		strcpy(student_name, surname);
		strcat(student_name, " ");
		strcat(student_name, name);
		strcat(student_name, " ");
		strcat(student_name, middlename);
		scanf("%s", subject_name);
		choice = 2;
	...
	case 2:
		marks = search_name(students, count, student_name,subject_name);
		printf("%f\n",marks);
		break;
	...
	case 7:
		if (count > 0)
			;
		int gr1 = find_strength(students, count, subject_name, 1);
		int gr2 = find_strength(students, count, subject_name, 2);
		int gr3 = find_strength(students, count, subject_name, 3);
		int gr4 = find_strength(students, count, subject_name, 4);
		int gr5 = find_strength(students, count, subject_name, 5);
		int gr6 = find_strength(students, count, subject_name, 6);
		int gr7 = find_strength(students, count, subject_name, 7);
		int gr8 = find_strength(students, count, subject_name, 8);
		int gr9 = find_strength(students, count, subject_name, 9);		
		int gr10 = find_strength(students, count, subject_name, 10);
